<template>
    <navbar
    :konferensiName="konferensi.confName"
    :konferensiDetail="konferensi.detailConf"
  />

  <div class="row justify-content-center">
    <div class="col-lg-4">
      <!-- Display logo on the left -->
      <img :src="'/assets/images/' + konferensi.confImages" class="img-fluid imgj" alt="Repository Logo" width="350"/>
    </div>
    <div class="col-lg-4 d-flex align-items-center">
      <!-- Display title and description on the right -->
      <div>
        <div v-if="konferensi.detailConf">
          <h2 class="ffss mb-4 text-white">About Conference</h2>
          <p class="fssss mb-4 text-2 text-white">{{ konferensi.detailConf }}</p>
        </div>
        <div v-else>
          <p class="text-white">No description found.</p>
        </div>
  ...
  <div class="row mt-lg-6 component2 justify-content-center"> <!-- Add justify-content-center class to center the second row -->
    <div class="col-lg-3 d-flex align-items-center">
      <!-- Display title and description on the right -->
      <div>
        <h2 class="ffss mb-1 text-white">Submit Konferensi Paper</h2>
        <p class="fssss mb-5 text-1 text-white">Submit konferensi paper anda ke Jurnal kami</p>
    ...
    <div class="col-lg-4 text-center">
      ...
      <img src="../assets/images/laptop.png" class="img-fluid oval-image" alt="Repository Logo" width="600"/>
    </div>
  </div>
...
export default {
  ...
  methods: {
    setConference(data) {
      this.konferensi = data;
      console.log(this.konferensi);
    },
  },
  mounted() {
    axios
    .get("http://localhost:3000/conference/"+this.$route.params.id)
